...
export default function MobileSidebar({ isOpen, onClose }) {
  ...
  return (
    <div className="fixed inset-0 z-50">
      ...
      <aside className="absolute left-0 top-0 h-full w-64 bg-black/85 shadow-xl p-6 overflow-y-auto">
        <button className="btn btn-ghost btn-sm mb-4" onClick={onClose} aria-label="Close sidebar">Close</button>
